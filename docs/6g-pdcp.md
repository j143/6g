...
PDCP handles header compression, ciphering, and integrity protection of user-plane and control-plane PDUs. The 6G baseline inherits directly from 5G NR PDCP (3GPP TS 38.323), with the primary experiment being integration of AI-assisted header compression.
